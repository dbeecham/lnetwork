...
static const char sqlite_schema[] =
    ...
    "create table link ("
        "ifid int not null,"
        "linked_ifid int not null,"
        "primary key (ifid),"
        "foreign key (ifid) references interfaces(ifid) on delete cascade on update cascade,"
        "foreign key (linked_ifid) references interfaces(ifid) on delete cascade on update cascade"
    ") without rowid;"
    "create table names ("
        "ifid int not null,"
    ...
    "create table hwaddr ("
        ...
        "foreign key (ifid) references interfaces(ifid) on delete cascade on update cascade"
    ") without rowid;"
    "create table perm_addr ("
        "ifid int not null,"
        "perm_addr text not null unique check (length(perm_addr)<=64) check (length(perm_addr)>0),"
        "primary key (ifid),"
        "foreign key (ifid) references interfaces(ifid) on delete cascade on update cascade"
    ") without rowid;"
    "create table ipv6 ("
    ...
    "create table mtu ("
        ...
        "foreign key (ifid) references interfaces(ifid) on delete cascade on update cascade"
    ") without rowid;"
    "create table min_mtu ("
        "ifid int not null,"
        "min_mtu int not null,"
        "primary key (ifid),"
        "foreign key (ifid) references interfaces(ifid) on delete cascade on update cascade"
    ") without rowid;"
    "create table max_mtu ("
        "ifid int not null,"
        "max_mtu int not null,"
        "primary key (ifid),"
        "foreign key (ifid) references interfaces(ifid) on delete cascade on update cascade"
    ") without rowid;"
    "create table txqlen ("
